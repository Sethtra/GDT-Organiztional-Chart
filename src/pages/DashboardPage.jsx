        ...
        <form onSubmit={handleSubmit} className="new-chart-modal__form">
          ...
          <div className="new-chart-modal__templates">
            ...
            >
              ...
              <div>
                <div className="new-chart-template-card__title">
                  GDT Template
                </div>
                <div className="new-chart-template-card__sub">
                  Start with the official GDT org chart
                </div>
              </div>
            </div>
            <div
...
export default function DashboardPage() {
  ...
  const pendingCharts = filteredCharts.filter(
    (c) =>
      c.owner_id !== user?.id &&
      c.chart_shares?.some(
  ...
  const sharedCharts = filteredCharts.filter(
    (c) =>
      c.owner_id !== user?.id &&
      !c.chart_shares?.some(
        (s) => s.shared_email === user?.email && s.status === "pending",
    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-content">
        ...
        <div className="dashboard-header">
          <div>
            <h1 className="dashboard-title">My Charts</h1>
        ...
        {loading && (
          <div className="dashboard-loading">
            <Loader2
              size={32}
              className="spin"
              style={{ color: "#0e7d6e", opacity: 0.7 }}
            />
          ...
          <>
            ...
            <section className="dashboard-section">
              ...
              {ownedCharts.length === 0 ? (
                ...
                <div
                  className={viewMode === "grid" ? "chart-grid" : "chart-list"}
                >
                ...
                >
                  {pendingCharts.map((chart) => (
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to right, var(--bg-surface), var(--bg-surface-2))",
